...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {
                0: [
                    "Data_CH0@DT5730SB_Cs137_Problem_Waveform_1103.CSV",
                    "Data_CH0@DT5730SB_Cs137_Problem_Waveform_1103_1.CSV",
                ],
                1: [
                    "Data_CH1@V1725_Cs137_Normal_List_241107.CSV",
...
@pytest.mark.parametrize(
    "directory, expected_times, expected_energies",
    [
        (
            COMPASS_DATA_DIR,
            {
...
def test_get_start_stop_time(
    run_info_filepath, expected_start_time_str, expected_stop_time_str
):
    time_format = "%Y/%m/%d %H:%M:%S.%f%z"
    expected_start_time = datetime.datetime.strptime(
        expected_start_time_str, time_format
    )
